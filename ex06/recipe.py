...
def create_recipe(name, ingredients, meal , prep_time):
    if (name in cookbook):
        print("\n\nThis recipe already exist. Do you want to delete it before recreate?\n\n")
    else:
...
5: Quit\n")
    if input_user == '1':
        ...
        ingredients = input("\nPlease enter the ingredients of the repice: (Syntaxe is : ingredient1, ingredient2, ingredient3) \n")
